...
<!-- A change to test this Rmd -->

<!-- Read Gelman on problems with testing. GP: Not yet. -->

<!-- Read chapter 8 and 11.  -->

<!-- Add comments to important code chunks, like the EDA graphic. -->

<!-- Place Population Table at the start of Justice. -->

<!-- Add discussion of why Wisdom has nothing to do with representativeness. Use basketball player example. The  best way to be sure that your data is representative of the population is for the process which selected that data to be random. Almost never true! Even if NHANES is a perfect survey --- things are still hard. And no survey is perfect. People in jail? People in hospitals?  -->
...
<!-- Add back reference to ch 12 when it shows up again. GP: Can't do this yet (have not read that far) -->
...
<!-- This EDA is not very good and does not build naturally to where we want to be. GP: Fixed (hopefully) -->
...
<!-- I feel as though the entire 7.1.3 section can be summarized in one paragraph and placed as an introduction to the subsequent section — I don't think the message merits its own entire section. GP: Ask preceptor about the difference between the discussion of "population" in Wisdom, and the discussion of "representativeness" in Justice. (These feel largely like a repeat of the same information; in Wisdom you are *assuming* the data is represantitive, and in Justice you are *asking* whether the data is representative?) Until then, I'm not sure how to organize these last few sections... -->
...
<!-- The equivalence of the two above statements is not immediately apparent. So fix it. GP: Fixed -->
...
<!-- \epsilon_i \sim N(0, \sigma^2) warrants elaboration, as drawing an error term from a normal distribution like this is not something that has been discussed previously. GP: Done! -->
